...
for (let i = 0; i < 16; i++) {
    dummyUnstagedFiles.push({
        statusCode: "M",
        status: "modified",
        formattedPath: "/a/really/super-super/duper/long/path/that/is/actually/like/really/long.jpg",
        originalPath: "/a/really/super-super/duper/long/path/that/is/actually/like/really/long.jpg",
